...
public class ScanListview extends ListView {
    ...
    public ScanListview(Context context,AttributeSet attrs) {
        this(context, attrs,0);
    }

    public ScanListview(Context context, AttributeSet attrs, int defStyle) {
...
//        TranslateAnimation outAnimation = new TranslateAnimation(mLayoutParams.leftMargin, 0, 0,
//                0);
//        outAnimation.setDuration(durationMillis);
//        mPointChild.startAnimation(outAnimation);
